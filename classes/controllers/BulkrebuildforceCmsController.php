 ...
 * @version   $Id: BulkrebuildforceCmsController.php 2012 2010-02-17 13:34:44Z ryans $
 */
 ...
 * @package   CrowdFusion
 */
class BulkrebuildforceCmsController extends AbstractBulkActionController
{
    ...
    public function execute() {
        ...
        foreach($noderefs as $noderef) {
            ...
            try {
                ...
                $this->ImageService->forceRebuildThumbnails($noderef);
