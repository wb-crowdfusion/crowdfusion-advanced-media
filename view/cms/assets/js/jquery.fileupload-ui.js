...
(function ($) {
    ...
    UploadHandler = function (container, options) {
        ...
        // Hack to make multiloader accessible externally
        // - Michele
        this.multiLoader = new MultiLoader(function (list) {
        ...
        this.onLoad = function (event, files, index, xhr, handler) {
            ...
            var uploadTable = getUploadTable(handler),
                ...
                callBack = function () {
                    ...
                    self.multiLoader.complete();
                };
            this.multiLoader.push(Array.prototype.slice.call(arguments, 1));
